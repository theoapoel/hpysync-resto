...
class OnlineReportController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Reports/Online', [
            'posProfile' => $posProfile,
            'dateLocked' => $dateLocked,
            'fetchUrl' => route('online-report.fetch'),
            'detailUrlBase' => url('online-report/detail'),
        ]);
    }
    ...
    public function fetch(Request $request)
    {
        ...
        $localMap = Transaction::whereIn('erp_pos_invoice', $invoices->pluck('name')->filter()->all())
